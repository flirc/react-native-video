...
@interface RCTVideo : NSView
//#if __has_include(<react-native-video/RCTVideoCache.h>)
//@interface RCTVideo : NSView <RCTVideoPlayerViewControllerDelegate, DVAssetLoaderDelegatesDelegate, AVAssetResourceLoaderDelegate>
//#elif TARGET_OS_TV
//@interface RCTVideo : NSView <RCTVideoPlayerViewControllerDelegate, AVAssetResourceLoaderDelegate>
//#else
//@interface RCTVideo : NSView <RCTVideoPlayerViewControllerDelegate, AVPictureInPictureControllerDelegate, AVAssetResourceLoaderDelegate>
//#endif
